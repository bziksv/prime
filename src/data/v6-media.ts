...
export const v6Faq = [
  {
    ...
    a: "Платите только за фразы в ТОП-10. Список фиксируем после аудита — без абонентской «воды».",
    icon: v6Icons.iconSeo,
  },
  {
    q: "Сколько до первых заявок?",
    a: "Контекст — от 1–2 недель; SEO — обычно 2–4 месяца до устойчивых позиций и заявок.",
