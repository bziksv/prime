...
const partnerEn: PartnerContent = {
  ...
  heroTitleAccent: "get paid",
  heroTitleAfter: " when clients do",
  heroLead:
    "Send us clients for SEO, Google Ads, and web development. We run the work, report every month, and pay partners on actual billings — under contract, no fog.",
  ...
  benefits: [
    ...
    },
    {
      ...
      text: "Case studies stay public. Rankings, leads, CPL — easy to point at when you refer.",
      tone: "m",
    },
    {
      title: "We share what we know",
      text: "SEO, Google Ads, and analytics — practice and news so you stay sharp worldwide.",
      tone: "e",
    },
    {
  ...
  casesViewAll: "See all case studies",
  casesViewAllHref: "/keysy/",
  ...
  steps: [
    ...
    },
    {
      n: "04",
      title: "Go live",
      text: "You pass contacts (client knows we’re calling) — and we start.",
    },
  ],
