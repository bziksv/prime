...
export const caseTranslationsEnBatch16: Record<string, Partial<CaseStudy>> = {
  "volvo-chernozeme": {
    ...
    summary:
      "New Bitrix site + SEO (87 phrases) and paid search/social for a Volvo dealer: prep ~2.5 months, TOP planned 2–6 months, ≈103 showroom inquiries monthly. Belgorod — separate case.",
    coverAlt: "Volvo XC90 — dealer model lineup",
    services: ["SEO", "Website", "Bitrix", "Paid search", "Social ads"],
    intro:
      "The Volvo dealer in the Black Earth region came after our other dealership projects in the area. The job — reach interested audience in search, paid search, and social, and build a new site in parallel. Separate case — Volvo Belgorod SEO.",
    painLead:
    ...
    challenge:
      "In ~2.5 months launch a new site and prepare SEO (87 phrases) plus paid search and social channels. Climbing into TOP-10 — planned over 2–6 months; showroom inquiries and sales grow with visibility.",
    pains: [
      {
        title: "Serious SERP competition",
        text: "Premium dealers and aggregators split the queries. Without a full phrase pool and a strong site, audience goes elsewhere.",
      },
      {
      ...
      },
      {
        ...
        text: "Before us — 0 phrases in TOP, ~12 visits, 2 showroom inquiries. They needed full channel coverage, not “a couple of keywords”.",
      },
    ],
    journeyLead:
      "We built semantics and strategy (SEO + paid search + social), designed and launched the Bitrix site, then optimization, copy, articles, and CTAs. After ~2.5 months the project was live; then rankings on 87 phrases, traffic, and showroom visits.",
    approach: [
      "Semantic core and add-on semantics → 87 phrases",
      "Demand and competition analytics in premium auto",
      "Strategy: search + paid search + social on one audience",
    ...
    plainSpeak: [
      {
        ...
        plain:
          "Who searches Volvo — in organic; who is ready to click an ad — in paid search and social. One brief, different doors into the showroom.",
      },
      {
        jargon: "Site + SEO in ~2.5 mo.",
        plain:
          "First we launched a modern dealer Bitrix site, then spun the core. Prep ≠ instant TOP: rankings — planned 2–6 months.",
      },
      {
    ...
    outcomeLead:
      "In ~2.5 months we prepared the site and channels — that is not TOP. Climbing into TOP is planned over 2–6 months. Already in the first two months: ~90 visits/day, 14 showroom inquiries, 6 sales. Then — about ≈103 showroom inquiries monthly. Belgorod case — separate.",
    highlights: [
      "Volvo Black Earth: Bitrix site + SEO + paid/social",
      "87 phrases · prep ~2.5 mo.",
      "TOP planned 2–6 mo. (month-by-month growth)",
      "Before us: 0 in TOP · ~12 visits · 2 showroom inquiries",
    ...
    ctaText:
      "We’ll build the site and channels for a dealer — like Volvo in the Black Earth region.",
  },

  ofisy: {
    title: "Paid search for an office center — tenants",
    ...
    summary:
      "Google Ads and search ads for an office center: launch in 2 days, budget ≈$200. In two months — 14 calls and 6 leases; all vacant space filled.",
    coverAlt: "Office business center — facade",
    services: ["Google Ads", "Search ads", "Semantics"],
    intro:
    ...
    painLead:
      "Classifieds weren’t closing the vacancy. Long-horizon SEO would bring “cheaper” clients, but free offices are finite — and site demand would fade once filled. They needed a fast channel: paid search on a tight budget.",
    challenge:
      "In 2 days launch Google Ads and search ads, stay within ≈$200, keep CPC low, and lease all vacant space.",
    pains: [
      {
        title: "A third of the building empty",
        text: "Classified listings sat for months. They needed hot “office rental” queries — not more passive posts.",
      },
      {
        title: "Need fast results",
        text: "Long SEO is overkill here: few offices, once leased the channel demand drops. Paid search brings leads now.",
      },
      {
        title: "Tight budget",
        text: "Stay around ≈$200, don’t inflate CPC, and cut weak directions.",
      },
    ],
    journeyLead:
      "We studied competitor USPs, built semantics, wrote ads, and assembled campaigns in Google Ads and search ads. Budget went to strong keywords; weak ones were off. Launch — in 2 days.",
    approach: [
      "Semantics for office rental",
      "USPs and ad copy",
      "Campaigns in Google Ads and search ads",
      "Budget focused on the strongest queries",
      "Top ad position at minimal CPC",
    ...
    plainSpeak: [
      {
        ...
        plain:
          "We didn’t wait months for organic: keys, ads, go live — tenants came from hot queries.",
      },
      {
        jargon: "Budget ≈$200",
        plain:
    ...
    sections: [
      {
        ...
        body: "The job was practical: fill empty space. Paid search worked faster than classifieds and without long SEO.",
        image: "/images/cases/ofisy/cover.webp",
      },
      {
        title: "Google Ads and search ads",
        body: "Two ad contours for rental. Goal — top ad position at low CPC without waste on junk queries.",
    ...
    outcomeLead:
      "In 2 days we launched ads. In the first two months — about 42 visits/day, 14 calls, and 6 lease contracts. In the end all vacant offices were leased; about ≈14 inquiries per month at distance.",
    highlights: [
      "Paid search for office rental · Voronezh",
    ...
    ctaTitle: "Need to lease space through paid search?",
    ctaText:
      "We’ll build semantics and campaigns for rental — like the office center in Voronezh.",
  },
  ...
  "milk-for": {
    ...
    location: "Voronezh → Russia-wide",
    period: "since 2016",
    metric: "~40",
    metricLabel: "company inquiries per month",
    summary:
      "SEO for a milk-filter maker: site from scratch (specs and build oversight), 45 phrases, prep ~42 days, TOP planned 2–6 months. From regional to nationwide demand — ≈40 inquiries per month.",
    ...
    painLead:
      "Regional reach wasn’t enough: they needed Russia-wide visibility. The niche is narrow and “hard”, and there was no site. Needed: specs for outside developers, build oversight, then SEO and CTAs for wholesale and farms.",
    challenge:
      "In ~42 days accept the site and prepare SEO (45 phrases). Climbing into TOP-10 — planned over 2–6 months; inquiries and wholesale purchases grow with rankings.",
    pains: [
      {
        title: "No site — no nationwide channel",
        text: "Voronezh demand exists, but without a search-ready site you don’t reach all of Russia. Needed a storefront for filters and husbandry.",
      },
      {
        title: "Tough B2B niche",
        text: "Not mass market: farms and dairy plants. Core and copy must speak to a buyer — not “milk in a store”.",
      },
      {
        title: "Zero visibility",
        text: "0 queries in TOP, no organic or web profit. Start from scratch after site acceptance.",
      },
    ],
    journeyLead:
      "We picked a contractor by ratings, wrote specs, and monitored the build. In parallel — semantics and strategy. Accepted the site, added calculators and CTAs, started optimization. After ~42 days the project was live; then rankings on 45 phrases and leads.",
    approach: [
      "Developer monitoring, designer pick, specs, and site acceptance",
      "Semantics and competition analysis → 45 phrases",
    ...
    plainSpeak: [
      ...
      },
      {
        ...
        plain:
          "A compact core for filters and husbandry. In about a month and a half the site and SEO were live; steady TOP — another planned 2–6 months.",
      },
      {
    ...
    sections: [
      {
        title: "From the Black Earth region — to all of Russia",
    ...
    outcomeLead:
      "In ~42 days we prepared the site and SEO — that is not TOP. Climbing into TOP is planned over 2–6 months. Already in the first two months: ~18 visits/day, 52 inquiries, 9 wholesale buys. Then — about ≈40 inquiries per month. Site: milkfor.ru.",
    highlights: [
      "Milk-filter SEO · nationwide reach",
      "45 phrases · prep ~42 days (site + SEO)",
      "TOP planned 2–6 mo. (month-by-month growth)",
      "Specs and oversight of outside site build",
      "Before us: 0 in TOP · 0 organic · 0 web profit",
    ...
    ctaText:
      "We’ll build the site and core for a narrow niche — like MilkFor.",
  },
};
