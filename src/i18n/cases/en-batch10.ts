...
export const caseTranslationsEnBatch10: Record<string, Partial<CaseStudy>> = {
  "det-zentr": {
    ...
    painLead:
      "In the Moscow suburbs search is cut by zones: Lyubertsy has its own. Without local keywords and strong landings the center isn’t visible next to competitors. Before us — zero ranking queries, no organic, no web clients.",
    challenge:
      "In ~1 month prepare SEO for Lyubertsy/Zhulebino: keyword set, copy, CTAs. Page-one growth — planned over 2–6 months.",
    pains: [
      {
        title: "Local Moscow-region search",
        text: "Queries like “children’s center Lyubertsy” and “Montessori Zhulebino” live in their own geo zone. Need keywords and content for that district, not “Moscow in general.”",
      },
      {
        title: "Zero visibility",
        text: "Before start — zero ranking phrases, no search visits or clients. Need a launch from scratch.",
      },
      {
    ...
    journeyLead:
      "We built keywords for Lyubertsy, strategy and CTAs, optimized the site, wrote copy and articles. In ~1 month prep was done and the project was live; then rankings on 23 phrases and a flow of parent inquiries.",
    approach: [
      "Keyword set and supporting semantics for the Moscow region",
    ...
    plainSpeak: [
      ...
      },
      {
        ...
        plain:
          "The client approved a short list: development, speech therapy, Montessori, school prep, geo. We hold page one on them and count calls.",
      },
      {
    ...
    sections: [
      {
        title: "A private center in local search",
      ...
      },
      {
        ...
        body: "The client approved 23 phrases. Local search report for Lyubertsy — page one on speech therapy, development, Montessori, school prep, and geo queries.",
    ...
    gallery: [
      ...
      },
      {
        ...
        caption: "Page one on the local set",
        fit: "contain",
      },
      {
    ...
    outcomeLead:
      "In ~1 month we prepared SEO in Lyubertsy — that is not the same as page one. Rankings were planned over 2–6 months; we held about 90 web calls monthly. In the first two months — dozens of calls and dozens of new kids from search.",
    highlights: [
    ...
    ctaText:
      "We’ll build local keywords and get the site to calls — the same way we did for Svetlyachok in Lyubertsy.",
  },
  ...
  "bel-kuzov": {
    ...
    intro:
      "Fortuna-avto is a large auto service in Belgorod: body repair, polishing, detailing, paint — at official Volvo and Subaru dealers. They first came for SEO; later we connected paid search — a separate Google Ads case.",
    painLead:
      "Before us the site barely worked for search: one page, zero ranking queries, no web clients. They needed rankings for body repair and related services in Belgorod — and calls into the bays, not traffic for the report.",
    challenge:
      "In ~2 weeks prepare structure and the site for SEO. Page-one growth on the keyword set — planned over 2–6 months.",
    pains: [
      {
      ...
      {
        title: "Zero visibility",
        text: "Zero ranking phrases, almost no organic or web clients. Need SEO from scratch.",
      },
      {
        title: "Competition in body work",
        text: "Commercial queries are taken. Need clusters, copy, and CTAs to overtake competitors on page one.",
      },
    ],
    journeyLead:
      "We built and clustered the keyword set, designed structure, optimized pages, wrote copy, and added CTAs. Prep in ~14 days; then ranking growth over 2–6 months; rankings on 135 phrases and a call flow. When organic moved — we connected Google Ads.",
    approach: [
    ...
    plainSpeak: [
      ...
      },
      {
        ...
        plain:
          "The client approved a wide list: body, glass, doors, hood, prices, geo. We hold page one on them and count calls.",
      },
      {
    ...
    sections: [
      ...
      {
        title: "Rankings on the keyword set",
        body: "The client approved 135 phrases. Report — page one on body work, fender/hood/door repair, windshield replacement, and Belgorod geo queries.",
      ...
      {
        title: "Services in search",
        body: "Landings and keywords tied to the real shop: body, glass, insurance repair — what people search after accidents and in daily use.",
    ...
    outcomeLead:
      "In ~14 days we prepared SEO — that is not the same as page one. Rankings were planned over 2–6 months; we held about 200 web calls monthly. Then we connected paid search — see the Fortuna-avto Google Ads case.",
    highlights: [
      "SEO for a Volvo/Subaru auto service in Belgorod",
      "135 phrases · prep ~14 days",
      "Site structure for services from scratch",
      "Page one on body work and related queries",
      "≈200 web calls per month",
      "Page one planned 2–6 mo. (month-by-month growth)",
      "Then connected Google Ads",
    ],
    results: [
    ...
    ctaText:
      "We’ll build keywords for body work and service — like Fortuna-avto in Belgorod. Google Ads can follow if you need a faster funnel.",
  },
  ...
  himopttorg: {
    ...
    painLead:
      "Without search, a multi-thousand flow of queries for acids, solvents, enamels, hoses, and gasket sheet went past the company. Before us — zero ranking phrases, no organic, no web clients. They needed rankings on commercial “buy” queries and calls/orders — not a storefront without traffic.",
    challenge:
      "In ~1 month prepare SEO for a B2B catalog: keyword research, copy, CTAs. Page-one growth — planned over 2–6 months in a competitive chemical niche.",
    pains: [
      {
        title: "B2B demand goes to search",
        text: "Buyers look for “buy hydrochloric acid,” “NC enamel,” “conveyor belt” — without search visibility the wholesaler loses volume.",
      },
      {
        title: "Zero visibility",
        text: "Zero ranking queries, visits and web clients — zero. Need prep from scratch, not a tweak.",
      },
      {
        title: "Wide catalog — many clusters",
        text: "Coatings, chemicals, rubber goods, asbestos tech, plastics — without clustering and landings keywords don’t convert into orders.",
      },
    ],
    journeyLead:
      "We built the keyword set and strategy, optimized the site, wrote copy and articles, added CTAs. In ~1 month prep was done and the project was live; then rankings on 90 phrases, thousands of visits, and a steady call/order flow.",
    approach: [
      "Keyword set and supporting semantics",
    ...
    plainSpeak: [
      ...
      },
      {
        ...
        plain:
          "The client approved a set for high-demand SKUs. We hold page one on them and count calls and placed orders.",
      },
      {
    ...
    sections: [
      ...
      {
        title: "Rankings on the keyword set",
        body: "The client approved 90 phrases. Report — page one on commercial queries: acids, salts, enamels, hoses, conveyor belt, gasket sheet, and related SKUs.",
    ...
    outcomeLead:
      "In ~1 month we prepared SEO — that is not the same as page one. Rankings were planned over 2–6 months with month-by-month growth; we held about 200 web calls monthly. In the first two months — hundreds of calls and dozens of orders; then — about 6,000 visits a month. himopttorg.ru is still live.",
    highlights: [
    ...
    ctaText:
      "We’ll build keywords for your SKUs and get the site to calls — the same way we did for HimOptTorg.",
  },
};
