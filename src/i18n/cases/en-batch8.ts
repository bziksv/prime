...
export const caseTranslationsEnBatch8: Record<string, Partial<CaseStudy>> = {
  kosmamed: {
    ...
    painLead:
      "A huge out-of-the-box Bitrix catalog is heavy to serve: ORDER BY RAND() killed component cache, background and images bloated LCP, and a brand/domain change risked ranking equity and broken links without careful 301s and content edits.",
    challenge:
    ...
    outcomeLead:
      "A living Bitrix store with 55,000+ SKUs under the KosmaMed brand: domain and search redirects in place, storefront faster via cacheable sorting and WebP, integrations kept. Site: kosmamed.ru.",
    highlights: [
    ...
    ctaText:
      "We’ll handle domain change, 301s, and speed on a live catalog — the same way we did for KosmaMed.",
  },
  ...
  oftalmag: {
    ...
    intro:
      "Oftalmag is an online store of ophthalmology equipment for practices and clinics: ~1,900 SKUs, ~185 sections, Heine, Riester, KaWe and more, delivery. Platform — Bitrix, enext theme (altop.enext). We support the storefront, catalog, and buyer account.",
    painLead:
      "A specialized B2B Bitrix catalog: some SKUs without a retail price (“request a price”), need stable account SEF, a correct city-picker popup, and careful production CSS — otherwise requests and navigation break for no visible reason.",
    challenge:
      "Keep a living ophthalmology store: catalog and cards for clinics, buyer account, city and delivery — without rewriting the shop and without CSS breaks on prod deploy.",
    pains: [
      {
        title: "Account SEF",
    ...
    plainSpeak: [
      ...
      },
      {
        jargon: "City picker",
        plain:
          "The buyer sets the city — delivery and terms depend on it.",
      },
    ],
    sections: [
      {
    ...
    outcomeLead:
      "A living ophthalmology-equipment store on Bitrix enext: ~1,900 SKUs, stable account and storefront, correct city picker. Site: oftalmag.ru.",
    highlights: [
      "Ophthalmology store · ~1,900 products · ~185 sections",
      "Bitrix enext · Heine · KaWe · Riester",
      "“Request a price” · city picker · delivery",
      "Account SEF · city popup CSS fix",
    ...
    ctaText:
      "We’ll shape the catalog and account for clinics — the same way we did for Oftalmag.",
  },
  ...
  metprof: {
    ...
    painLead:
      "An ERP catalog with thousands of trade offers (RAL colors, NormanMP coatings, and more) easily breaks UX: the header cart doesn’t update after “add to cart”, the admin crashes without Access modules in git, and SEO copy and deploys need discipline.",
    challenge:
    ...
    approach: [
      ...
      "ERP exchange: products, offers, lengths",
    ...
    plainSpeak: [
      ...
      },
      {
        ...
        plain:
          "The buyer estimates footage and fencing kit before calling a manager.",
      },
      {
    ...
    ctaText:
      "We’ll build the catalog, cart, and calculators — the same way we did for Metallinvest Profile.",
  },
};
