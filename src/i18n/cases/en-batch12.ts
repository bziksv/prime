...
export const caseTranslationsEnBatch12: Record<string, Partial<CaseStudy>> = {
  respect: {
    ...
    painLead:
      "A used-car showroom competes with private sellers and classifieds. Without strong rankings for “used cars Voronezh,” “buy used car on credit,” and appraisal, demand goes elsewhere. Before us — zero ranking phrases, no organic, no web clients.",
    challenge:
      "In ~1 month prepare SEO for a used-car showroom: a wide keyword set, copy, CTAs. Page-one growth — planned over 2–6 months on commercial queries.",
    pains: [
      {
    ...
    journeyLead:
      "We built a wide keyword set and strategy, optimized the site, wrote copy and articles, added CTAs. In ~1 month prep was done and the project was live; then rankings on 162 phrases and a steady call flow.",
    approach: [
    ...
    plainSpeak: [
      ...
      },
      {
        ...
        plain:
          "The client approved a wide set: mileage, credit, appraisal, showroom, geo. We hold page one on them and count calls.",
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "The client approved 162 phrases. Report — page one on used cars, credit, appraisal, and “showroom Voronezh” queries.",
    ...
    outcomeLead:
      "In ~1 month we prepared SEO — that is not the same as page one. Rankings were planned over 2–6 months; we held about 400 web calls monthly. In the first two months — hundreds of visits and calls per day combined; car sales beat the plan.",
    highlights: [
      "Used-car showroom at Motor Land",
      "162 phrases · prep ~1 mo.",
      "Page one — mileage, credit, appraisal, geo",
    ...
    ctaText:
      "We’ll build keywords for mileage, credit, and appraisal — the same way we did for Respect / Motor Land in Voronezh.",
  },
  ...
  hobby36: {
    ...
    painLead:
      "They wanted to reinforce the offline shop with a 24/7 web storefront. Before us — zero ranking phrases, no organic, no web clients. They needed rankings on commercial niche queries and online calls/deals.",
    challenge:
      "In ~1 month prepare SEO for a hobby store: category keywords, copy, CTAs. Page-one growth — planned over 2–6 months.",
    pains: [
      {
      ...
      {
        title: "Narrow but high-intent niches",
        text: "Bows, search magnets, coin albums — queries aren’t mass-market, but intent to buy is clear.",
      },
    ],
    journeyLead:
      "We built the keyword set and strategy, optimized the site, wrote copy and articles, added CTAs. In ~1 month prep was done and the project was live; then rankings on 54 phrases and a steady flow of calls and deals.",
    approach: [
      "Keyword set and supporting semantics",
    ...
    plainSpeak: [
      ...
      },
      {
        ...
        plain:
          "The client approved a set by key categories. We hold page one on them and count calls and deals.",
      },
      {
        jargon: "CTAs on the site",
        plain:
    ...
    sections: [
      {
        ...
        body: "From bows and paintball to numismatics and metal detecting — niches are narrow, but a search buyer already has clear intent.",
        image: "/images/cases/hobby36/cover.webp",
      },
      {
        title: "Rankings on the keyword set",
        body: "The client approved 54 phrases. Report — page one on bows, search magnets, coin albums and sets, metal detectors.",
    ...
    outcomeLead:
      "In ~1 month we prepared SEO — that is not the same as page one. Rankings were planned over 2–6 months with month-by-month growth; we held about 100 web calls monthly. In the first two months — hundreds of visits and calls; online deals reached parity with the offline store. Later we refreshed the store itself.",
    highlights: [
      "Hobby-store SEO: bows, numismatics, metal detecting",
      "54 phrases · prep ~1 mo.",
      "Page one on commercial categories",
    ...
    ctaText:
      "We’ll build keywords for your categories — the same way we did for Mir Uvlecheniy in Voronezh.",
  },
  ...
  "volvo-belgorod": {
    ...
    painLead:
      "Premium demand is crisis-sensitive. Without strong rankings for “Volvo Belgorod,” “official dealer,” XC60, and related queries the showroom loses high-intent clients. Before us — zero ranking phrases, no organic, no web clients.",
    challenge:
      "In ~1 month prepare SEO for a Volvo dealer in Belgorod: a wide keyword set, copy, CTAs. Page-one growth — planned over 2–6 months.",
    pains: [
      {
    ...
    journeyLead:
      "We built the keyword set (client approved ~96 phrases), strategy, optimized the site, wrote copy and articles, added CTAs. In ~1 month prep was done and the project was live; then rankings and a flow of showroom visits.",
    approach: [
      "Keyword set and supporting semantics",
    ...
    plainSpeak: [
      ...
      },
      {
        ...
        plain:
          "The client approved the set: dealer, showroom, models, geo. We hold page one on them and count showroom visits.",
      },
      {
        jargon: "CTAs on the site",
        plain:
    ...
    sections: [
      {
        ...
        body: "Belgorod and the Volvo brand — local dealer and model queries. The job — earn page one and bring people into the showroom.",
        image: "/images/cases/volvo-belgorod/cover.webp",
      },
      {
        title: "Rankings on the keyword set",
        body: "The client approved promotion on 96 phrases. Report — page one on “Volvo Belgorod,” dealer, showroom, and XC60.",
    ...
    outcomeLead:
      "In ~1 month we prepared SEO — that is not the same as page one. Rankings were planned over 2–6 months with month-by-month growth; we held about 112 showroom visits monthly from search. In the first two months — strong traffic and calls; sales above plan.",
    highlights: [
      "SEO for official Volvo dealer in Belgorod",
      "96 phrases · prep ~1 mo.",
      "Page one — dealer, showroom, XC60, geo",
    ...
    ctaText:
      "We’ll build keywords for the dealer and models — the same way we did for Volvo in Belgorod.",
  },
};
