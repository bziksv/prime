...
export { EN_CASE_SLUGS, isEnCaseSlug } from "./slugs";
export { caseTranslationsEn, localizeCase, localizeCategory, isCaseTranslated } from "./localize";
...
export const caseUi: Record<"ru" | "en", CaseUi> = {
  ru: caseUiRu,
  en: caseUiEn,
};
...
/** Path for a case: EN only when a translation exists. */
