...
export const trendySeoEn: BlogPost = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "It’s harder to compete on broad head terms, but niches, region, expertise, and mid/long-tail with a strong answer remain. You still need to prep the site and core; TOP for the core is planned months of work.",
    },
    {
  ...
  sections: [
      ...
      lists: [
        {
          ...
          items: [
            ...
            "the SERP fragment should be honest and useful;",
            "you compete with aggregators and search’s own services;",
            "a key for the key’s sake is weaker than a full answer to the user’s job.",
          ],
        },
      ],
      links: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "When CTR from results falls, a clickable snippet’s value rises. Tune title and description to intent: numbers, clear benefit, no clickbait that doesn’t match the page. A readable URL helps people and sometimes the snippet.",
        "On the page itself the first screen should quickly confirm the person landed right: subheads, answer, solid mobile layout. That affects whether they bounce back to the SERP in a second (a rough “click length” / satisfaction signal).",
      ],
      lists: [
        {
          intro: "Quick fixes:",
          items: [
            ...
            "description complements, doesn’t duplicate title;",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Links and mentions via useful content and careful outreach still beat marketplace spam. Social networks are an extra reach channel: articles, infographics, short video and podcasts can bring people the SERP “ate” with zero-click.",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Tech, clear structure, an honest answer to the query, measuring leads — the base. Trends suggest accents (snippet, meaning, channels), but don’t cancel site prep and time to build rankings.",
        "Prep (core, copy, tech) — often about a month. A noticeable share of the commercial core in TOP — planned 2–6 months after work starts, growing month to month, with no date guarantee. “Adapted to a trend in a week — TOP” is a harmful myth.",
      ],
      lists: [
        {
          intro: "Bottom line:",
      ...
      notes: [
        {
          title: "Timelines",
          kind: "tip",
          text: "Reacting to trends ≠ instant TOP-10. Page quality and measurement first, then months of visibility buildup.",
        },
      ],
      links: [
        {
