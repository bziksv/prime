...
export const sozdanieInternetMagazinaEn: BlogPost = {
  ...
  excerpt:
    "Clean design, responsive layout, photos, navigation, payment and SSL, assortment, search, support, speed, and reviews — a base storefront checklist before you scale traffic.",
  lead: [
    ...
    "These ten points are worth locking down before heavy ad spend. We don’t recycle mobile-traffic share figures from old roundups — check your analytics; the mobile experience is almost always critical.",
  ],
  faq: [
    {
    ...
    },
    {
      ...
      a: "That piece covers hidden SEO and UX catalog traps (pagination, filters, pop-ups). This one is a base checklist when building the storefront.",
    },
    {
    ...
    {
      q: "Is HTTPS required for a store?",
    ...
    },
    {
      ...
      a: "After catalog structure, product pages, and tech basics. Prep usually takes weeks to about a month; getting the core into the TOP is planned for 2–6 months.",
    },
  ],
  sections: [
    {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Structure: categories by type or use, a visible menu, catalog and breadcrumbs — so people and search understand where things sit. Breadcrumbs help navigation; we don’t promise “magic TOP growth from breadcrumbs alone.”",
    ...
    },
    {
      ...
      paras: [
        ...
        "Speed: a slow product page and cart cut conversion. Fitting comfortable seconds matters more than chasing an abstract score; check on a real mobile device.",
