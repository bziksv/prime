...
export const korporativnoeObuchenieEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — barriers to self-study and principles: a plan, a measurable goal, an expert, an outside view, events. How to run an online format is in a separate piece; here — motivation and the model.",
  ],
  faq: [
    {
      q: "Why a system if market courses exist?",
    ...
    {
      q: "How to motivate beyond “develop yourselves”?",
  ...
  sections: [
    ...
    {
      title: "Expert and an outside view",
      level: 2,
      paras: [
