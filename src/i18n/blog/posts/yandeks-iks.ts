...
export const yandeksIksEn: BlogPost = {
  ...
  excerpt:
    "What Yandex SQI (IKS) was, how it differed from TIC, and why chasing an outdated score is pointless — which Webmaster reports to use instead of a “quality index.”",
  lead: [
    "SQI (site quality index, Russian ИКС) was Yandex’s public score that replaced TIC in 2018. It reflected demand and “quality” for audiences — not only link weight. The scale was stepped (10, 20, 40…), like old TIC.",
    "Since then the public SQI badge left the familiar Webmaster view: chasing a number from 2018–2019 guides is pointless. Below — why the metric appeared, how it differed from TIC, and what to use now. Webmaster does not put a site in TOP by hand; core share in TOP grows over months after work starts.",
  ],
  faq: [
    {
      q: "Is SQI still shown in Webmaster?",
      a: "As a familiar public badge — no. Orient on diagnostics, index, queries, security, and behavior in analytics.",
    },
    {
      q: "Is SQI = search position?",
      a: "No. Even in the SQI era a high score did not guarantee TOP. Ranking depends on relevance, page quality, and competition.",
    },
    {
    ...
    {
      q: "What to watch on competitors instead of SQI?",
  ...
  sections: [
    {
      ...
      level: 2,
      paras: [
        "TIC (thematic citation index) measured link weight from the late 1990s. By the 2010s rankings and link exchanges were built on it, while in general search zero-TIC sites often beat “fat” linked ones. The metric stopped explaining quality for users.",
        "In August 2018 Yandex announced the swap: TIC off, SQI on. The idea — show how useful the site is for audiences and the business around it, not only “how many links you bought.”",
      ],
      tables: [
        {
      ...
      notes: [
        {
          ...
          text: "Even when SQI was shown, it was a quality/demand indicator — not a dial “nudge the score → get TOP-10.”",
          kind: "tip",
        },
      ],
    },
    ...
    },
    {
      ...
      paras: [
        ...
        "Planned core share into TOP-10 after prep usually takes months (roughly 2–6), not “we nudged SQI in a week.”",
      ],
      lists: [
        {
          intro: "What to do instead of chasing the score:",
          items: [
            "close critical errors in Webmaster;",
            "strengthen useful URLs for demand;",
            "improve UX and conversion;",
            "watch clicks and queries;",
            "measure business goals in Metrika/CRM.",
          ],
        },
      ],
      links: [
    ...
    },
    {
      ...
      paras: [
        ...
        "“Trends” and other quality slices in the cabinet (if available in your version) beat one historical number: they tie to the site’s current state.",
      ],
      links: [
        {
          label: "Yandex Webmaster",
