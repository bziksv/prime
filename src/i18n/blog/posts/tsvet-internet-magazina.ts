  ...
  sections: [
    {
      ...
      level: 2,
      paras: [
        "Pull business visuals into one scheme: site, emails, product cards, outdoor. Complex palettes are rarely needed for small e-com; simpler is more recognizable.",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Color-wheel algorithm: (1) base color for brand emotion; (2) secondary — contrasting but compatible (often opposite on the wheel); (3) accent — for CTA and key labels, not the whole UI.",
        "Two accents at once (square on the wheel) complicate the storefront. Successful shops more often keep a short palette and repeat the accent in the funnel: Add to cart, In stock, promo badge.",
        ...
        "Bottom line: color strengthens clarity and brand if the product is needed. Experiment in spots (A/B on CTA/first-screen background) — don’t repaint the whole catalog every week.",
      ],
      links: [
        {
