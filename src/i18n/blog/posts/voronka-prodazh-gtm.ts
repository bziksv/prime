...
export const voronkaProdazhGtmEn: BlogPost = {
  ...
  excerpt:
    "How to tag an ecommerce funnel with Google Tag Manager and watch drop-offs in GA4: catalog → cart → checkout → order, events instead of outdated Universal Analytics “virtual pages”.",
  lead: [
    ...
    "Below — why the funnel, how to choose steps, how to send events to GA4 via GTM, and how to read drop-offs. Basic GTM (container, tags, Preview) is a separate article; here the focus is checkout. We don’t copy Universal Analytics screenshots or rigid “virtual page” guides from old tutorials.",
  ],
  faq: [
    {
    ...
    {
      q: "Do you still need virtual pages like in UA?",
    ...
    {
      q: "Can you duplicate the tag in the theme and in GTM?",
      a: "No: you’ll get double hits. One delivery channel — either the template or GTM.",
    },
    {
      q: "Does this replace a marketing auto-funnel?",
      a: "No. An auto-funnel is a touch scenario (ads, bot, email). Here — measuring the path on the site.",
    },
  ],
  sections: [
    {
      ...
      level: 2,
      paras: [
        "Without steps you see visits and rare purchases, but not where the path breaks: product card, cart, shipping, payment, or contact form.",
      ...
      lists: [
        {
          intro: "Typical jobs:",
          items: [
            "track interest in catalog and product cards;",
            "see add_to_cart and begin_checkout share;",
            "catch exits before payment;",
            "link drop-off to a specific page/error;",
            "check the effect of A/B and releases.",
          ],
        },
      ],
      links: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "First describe your site’s real checkout — not an “ideal” textbook scheme. A one-page landing has fewer steps; a store with variants and shipping has more.",
        "Common frame: category/product view → add to cart → cart → checkout (contacts, shipping, payment) → success page. Keep event names close to GA4 ecommerce recommendations so reports and ad pixels align.",
      ],
      lists: [
        {
          intro: "Example chain:",
          items: [
            ...
            "purchase / generate_lead on thank-you.",
          ],
        },
      ],
      notes: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "In GA4 you usually build the funnel in Explorations (Funnel exploration) or watch ecommerce reports if the recommended scheme is on. In Metrika — composite goals and step reports.",
        "Tab UI changes: what matters is the meaning (“event sequence”, “step drop-off”), not a 2019 cabinet screenshot. Compare periods before/after fixes and segments (mobile / desktop, traffic source).",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Drop-off on shipping and payment often needs transparent price, timelines, and working payment methods — not “one more pixel”. Drop-off on contacts — form length and trust (details, policy, phone).",
        "Catch broken buttons and redirects separately: an event that didn’t fire ≠ the user “didn’t want to buy”. Match DebugView with a real session.",
      ],
      lists: [
        {
