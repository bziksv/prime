...
export const httpsSeoEn: BlogPost = {
  ...
  lead: [
    "HTTPS (TLS) encrypts the channel between browser and site. For SEO it’s long been baseline: plain HTTP hurts trust and clean mirror consolidation.",
    "Below — HTTPS’s role in promotion and a migration checklist. Certificate types in more depth live in the SSL article; here the focus is SEO effect and the move.",
  ],
  faq: [
    {
      q: "Does HTTPS alone put you in the TOP?",
    ...
    },
    {
      ...
      a: "More often redirect chains, mixed content, an outdated sitemap/Webmaster property, or http/https duplicates. Fix the tech — don’t roll back to HTTP.",
    },
    {
      q: "How does this differ from the SSL article?",
      a: "SSL covers what a certificate is and which types exist. Here — why HTTPS matters for SEO and how to migrate without losing signals.",
    },
    {
  ...
  sections: [
    {
      ...
      paras: [
        ...
        "HTTPS doesn’t replace semantics and links. It’s a required layer next to speed, mobile layout, and a clear structure.",
      ],
      lists: [
        {
          intro: "What it gives in practice:",
          items: [
            "encryption for forms and cabinets;",
            "one canonical protocol;",
            "fewer warnings in Chrome and other browsers;",
            "baseline for ad cabinets and payment systems.",
          ],
        },
      ],
      links: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Old reviews of HTTPS share in the TOP (2014–2015) aren’t an argument today: almost all strong sites are already on https. Correlation “TOP sites use https” ≠ “https pushed them to the TOP.”",
