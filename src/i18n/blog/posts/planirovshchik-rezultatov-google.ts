...
export const planirovshchikRezultatovGoogleEn: BlogPost = {
  ...
  excerpt:
    "Performance Planner in Google Ads: forecast budget and conversions from live campaigns, seasonality, reallocating spend across campaigns — how it differs from Keyword Planner.",
  lead: [
    ...
    "It’s not Keyword Planner and not a manual “from scratch” forecast by search volume. Below — why the tool exists, which campaigns enter a plan, typical scenarios, and accuracy limits. Check current Ads click-paths: the UI has changed.",
  ],
  faq: [
    {
      q: "How is it different from Keyword Planner?",
      a: "Keyword Planner is demand and phrase-level estimates before/outside deep account stats. Performance Planner is budget scenarios for campaigns with history.",
    },
    {
      q: "Why doesn’t a campaign appear in the plan?",
      a: "Often not enough data: short run time, few clicks/conversions, or an unsupported strategy/type. Eligibility rules have changed — follow the tool’s hints.",
    },
    {
      q: "Is the forecast = reality?",
      a: "No. It’s a model. In practice deviation can be noticeable; use it as order of magnitude and scenario comparison — not a contract with Google.",
    },
    {
  ...
  sections: [
    {
      ...
      level: 2,
      paras: [
        "The tool builds a forecast: what spend you need for a clicks/conversions/value goal; how the “budget → result” curve shifts; how to allocate spend more sensibly across selected campaigns.",
        "For a meaningful plan, campaigns usually need to be live with a minimum of stats (days, clicks, conversions) and a supported bidding strategy. Exact thresholds — in help and account hints, not old “3 days / 3 clicks / 1 conversion” dogma.",
        "Creating a plan: pick campaigns → period and target metric → get a chart and scenario table. Handy to compare current mode with “max reach” and a CPA goal.",
      ],
      lists: [
        {
          intro: "Typical jobs:",
          items: [
            ...
            "growth ceiling for Search / dynamic campaigns;",
      ...
      notes: [
        {
          title: "Tip",
          kind: "tip",
          text: "Don’t copy numbers from others’ cases (old article currencies). Look at your own curve in the account.",
        },
      ],
    },
    {
      title: "Search growth and campaigns Keyword Planner can’t “hear”",
      level: 2,
      paras: [
        "Sometimes Keyword Planner struggles with narrow or special setups, while Performance Planner still draws growth headroom from live campaign history.",
    ...
    },
    {
      ...
      paras: [
        ...
        "After picking a scenario, lock bid/budget changes deliberately. A plan in the library doesn’t rebuild the account by itself.",
      ],
      lists: [],
      links: [
        {
  ...
  closing: [
    "Build a plan from campaigns with one goal, lock a target CPA, and compare 2–3 points on the curve — easier to agree a seasonal budget than arguing “by eye.”",
  ],
  related: [
