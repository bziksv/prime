...
export const tenevoyBanInstagramEn: BlogPost = {
  ...
  faq: [
    {
      q: "Does shadow ban exist officially?",
    ...
    },
    {
      ...
      a: "Not proven as a universal cause. Content quality, tag relevance, and no spam behavior matter more. Broken/banned hashtags definitely hurt.",
    },
    {
    ...
    },
    {
      ...
      a: "Often no. “Action blocked” is an explicit temporary limit on likes/Direct/posts. A shadow scenario is about invisibility in search/recommendations.",
    },
  ],
  sections: [
    {
      ...
      level: 2,
      paras: [
        "Typical complaint: the post has a hashtag, but it doesn’t appear in that tag’s results; new people barely see it, followers still do. Likes and comments from the “old” audience may continue.",
        "Since about 2017 authors discuss the topic a lot. Many SMM pros say bugs and competition in popular tags are often to blame — not a secret label on the account.",
      ],
      lists: [],
      notes: [
        {
    ...
    },
    {
      ...
      paras: [
        ...
        "Real reach risks: bots and mass actions, reports, banned/broken hashtags, low quality and copy-paste, a sudden unnatural activity pace.",
      ],
      lists: [
        {
          intro: "What more often hits visibility:",
          items: [
            "automation of follows/likes/comments;",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "From another (unrelated) account search a fresh post by a rare unique hashtag from the publication. Compare overall reach and hashtag/recommendation reach in business-profile insights — a sharp drop without a content change is worth investigating.",
