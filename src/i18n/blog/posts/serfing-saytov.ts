...
export const serfingSaytovEn: BlogPost = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Artificial visits spoil behavioral metrics, distort ad and SEO analytics, and can trigger antifraud. Search engines don’t “like” bought junk traffic.",
    },
    {
      ...
      lists: [
        {
          ...
          items: [
            ...
            "solve a captcha;",
            "make 1–2 internal clicks;",
            "sometimes — a like/vote (closer to social-signal boosting).",
          ],
        },
      ],
    },
      ...
      lists: [
        {
          ...
          items: [
            ...
            "risk of sanctions/filters when boosting is obvious.",
          ],
        },
      ],
      links: [
