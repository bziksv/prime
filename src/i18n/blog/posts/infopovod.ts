...
export const infopovodEn: BlogPost = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Tying your message to someone else’s hot news. It works with speed and taste; with cynicism and a forced fit it hits reputation.",
    },
    {
  ...
  sections: [
    {
      ...
      paras: [
        ...
        "A good hook answers: who cares, why now, and which brand role looks fitting — expert, participant, organizer — not a random jump on the trend.",
      ],
      lists: [
        {
      ...
      lists: [
        {
          ...
          items: [
            ...
            "the industry via associations and scoreboards",
          ],
        },
      ],
    },
