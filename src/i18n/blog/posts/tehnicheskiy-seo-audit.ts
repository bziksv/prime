...
export const tehnicheskiySeoAuditEn: BlogPost = {
  ...
  title: "Technical SEO audit: goals, tasks, and a DIY start",
  date: "2021-07-22",
  category: "SEO",
  ...
  faq: [
    ...
    {
      q: "How is it different from an “SEO audit” overall?",
  ...
  sections: [
    ...
    },
    {
      ...
      paras: [
        ...
        "An express check before promotion covers only critical issues. A full review needs a crawler and webmaster panels. Tools include Screaming Frog, Netpeak Spider, Titlo, plus Google Search Console and other webmaster tools.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      paras: [
        ...
        "A full audit — tech + on-page + semantics/structure + usability and competitive context. That’s a turnkey work plan, not one checklist.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      paras: [
        ...
        "A vendor spots systemic errors faster, separates critical issues from noise, and ties tech to semantics and structure. It makes sense when downtime costs more than the audit.",
      ],
      lists: [
        {
