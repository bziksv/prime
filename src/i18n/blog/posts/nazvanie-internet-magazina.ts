  ...
  sections: [
    ...
    },
    {
      ...
      paras: [
        ...
        "Assortment relevance: from the name it should be clear what you sell, or at least which feeling/category. Creative with no product anchor makes people guess — some leave for a clearer competitor.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      paras: [
        ...
        "Sound: say it aloud, on the phone, at speed. Avoid junctions that create double meanings. 1–2 words beat four. A neologism is fine if it’s easy to read and doesn’t break transliteration.",
      ],
      lists: [
        {
