...
export const wordpressPlaginyEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — install order and typical failures (nested archive, host upload bans). Which SEO plugins to pick — in a separate piece; here it’s install and basic security hygiene.",
  ],
  faq: [
    {
  ...
  sections: [
    {
      ...
      level: 2,
      paras: [
        "Back up files and DB, especially on production. Check PHP/WordPress version and plugin compatibility. Staging makes conflicts easier to catch.",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "In the console: Plugins → Add New. Find the name, open the card, click Install, then Activate. Menu labels may differ slightly by translation and version.",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Connect over FTP/SFTP (FileZilla, WinSCP, etc.) or the host file manager. Unpack the plugin locally into one folder named after the plugin and upload it to `wp-content/plugins/`.",
    ...
    },
    {
      ...
      paras: [
        ...
        "SEO stack choice — in a separate article; console login — in the WordPress admin piece.",
      ],
    },
  ],
  closing: [
