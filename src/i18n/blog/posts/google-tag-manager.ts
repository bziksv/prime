...
export const googleTagManagerEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — account and container, the tag → trigger → variable chain, working with GA4 and Yandex Metrica, Preview before publish. The UI changes; this is not a Universal Analytics 2020 screenshot walkthrough.",
  ],
  faq: [
    {
      q: "Is GTM required?",
    ...
    },
    {
      ...
      a: "Per Google’s instructions: part in `<head>`, part right after `<body>` opens (or the current scheme from the account). On every site template — no “native + GTM” duplicate of the same counter.",
    },
    {
      q: "Can you install Metrica via GTM?",
      a: "Yes: a tag with the counter ID and the goals/events you need. Don’t publish a draft and don’t also hard-code Metrica in the theme.",
    },
    {
      q: "Why Preview?",
      a: "To see which tags fired on the page before publishing to everyone. Without Preview it’s easy to ship empty or double tracking.",
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      paras: [
        ...
        "Start small: GA4 config / Metrica counter on All Pages, then phone clicks, form submit, purchase. Don’t spawn dozens of tags without a naming scheme.",
      ],
      lists: [
        {
