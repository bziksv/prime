...
export const futerSaytaEn: BlogPost = {
  ...
  faq: [
    {
      ...
      a: "Indirectly: navigation, contacts, a shared template. Mass identical SEO links in the footer barely “boost” rankings and look like spam.",
    },
    {
      q: "What’s required?",
    ...
    {
      q: "Do you need an HTML sitemap in the footer?",
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "A shared footer helps people find permanent sections — it isn’t a tool to “pump” queries. Natural internal links with normal names beat a long wall of commercial anchors.",
