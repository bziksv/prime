...
export const kraudMarketingEn: BlogPost = {
  ...
  lead: [
    ...
    "Goals, choosing platforms, and careful link placements are below. This isn’t a “new magic ranking shortcut” and doesn’t replace content on your own site. Mass paid reviews and undisclosed ads hurt reputation and platform rules.",
  ],
  faq: [
    {
    ...
    {
      q: "Will crowd links put me in the TOP in a month?",
      a: "We don’t promise that. Targeted visits and brand mentions — yes. Core visibility takes planned months of systemic work (typically 2–6 after promotion starts) — not a batch of comments.",
    },
    {
      q: "Do I need dofollow links at any cost?",
      a: "No. Links are often nofollow. Value is audience and trust; “link equity” is secondary.",
    },
    {
      q: "Can I buy review packs?",
  ...
  sections: [
    ...
    },
    {
      ...
      links: [
        {
          label: "SERM (search engine reputation management)",
          href: "/en/blog/serm/",
        },
        {
          label: "Buying links",
