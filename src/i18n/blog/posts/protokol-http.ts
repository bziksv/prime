...
export const protokolHttpEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — why HTTP exists, how the exchange works, how HTTPS differs, what matters to a webmaster. Response codes are covered separately; moving to encryption is in the HTTPS and SEO article.",
  ],
  faq: [
    {
    ...
    {
      q: "Where to see the response code?",
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "HTTP/1.1 was the long standard: many connections, request queues. HTTP/2 multiplexes streams; HTTP/3 often rides QUIC/UDP — less delay on bad networks. Enabled on the server/CDN side.",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "“HTTP in the address is outdated” — the unencrypted scheme is outdated; the protocol remains the web’s base. “HTTPS alone gives TOP” — no, it’s hygiene. “Status 200 is always good” — not if you serve an empty stub or a duplicate.",
      ...
      notes: [
        {
          title: "Practice",
          kind: "tip",
          text: "Keep a cheat sheet: protocol (HTTP) → encryption (TLS/HTTPS) → status → HTML. You isolate the problem layer faster. Clean HTTP isn’t a TOP shortcut — rankings for a core are still planned 2–6 months after prep.",
        },
      ],
    },
  ],
