...
export const userIntentEn: BlogPost = {
  slug: "user-intent",
  title: "User intent in SEO: working with query intention",
  date: "2018-08-29",
  category: "SEO",
  ...
  lead: [
    ...
    "Below — how to spot user intent from the SERP, when close intentions can share one page, and why “pulling” a foreign intent onto a commercial landing almost never works.",
  ],
  faq: [
    {
    ...
    {
      q: "How to see intent quickly?",
      a: "Open TOP-10–20 in private mode without personal history: which page types dominate — guides, product cards, aggregators, brands.",
    },
    {
      q: "One URL — several intents?",
      a: "Only if they combine naturally and are mixed the same way in the SERP. Otherwise — separate landings, or you get cannibalization and a weak answer.",
    },
    {
      q: "Can your article “change” SERP intent?",
      a: "Rarely. The SERP reflects behavior. Easier to match the dominant intent or take a rare but truly useful angle.",
    },
    {
      q: "Link to the semantic core?",
    ...
    },
    {
      ...
      a: "Often similar, not always: locality, commercial mix, SERP blocks differ. Check both if both channels matter.",
    },
    {
    ...
    {
      q: "How to measure that you hit intent?",
  ...
  sections: [
    {
      ...
      level: 2,
      paras: [
        "The same word set hides different jobs. A query like “ecommerce design” may mean inspiration from examples, a UX guide, trends, or buying a service/template.",
        "The SERP mixes those answers: roundups, long articles, images, commercial offers. Your page should clearly close one main scenario — the one you compete for.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Close informational angles (“design trends” + “good design principles”) sometimes live on one URL if the SERP mixes them the same way. An “oil ranking” and “buy oil” usually need different pages: a ranking reader rarely is ready to check out in the same visit.",
        "Before a copy brief, check SERP overlap (TOP analysis tools / manual review): if top documents differ by type — don’t glue clusters.",
      ],
      lists: [
        {
          intro: "Rule of thumb:",
    ...
    },
    {
      ...
      paras: [
        ...
        "Hence the practice: don’t “break” intent by force — own your niche inside it — a stronger card, a fairer comparison, a more useful guide — depending on what TOP already shows.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      notes: [
        {
          title: "Timelines",
          text: "Hitting intent speeds relevance, but competitive core rank buildup is still planned months (often 2–6) — not “TOP after one title tweak”.",
          kind: "tip",
        },
      ],
      links: [
