...
export const yuzabilitiInternetMagazinaEn: BlogPost = {
  ...
  excerpt:
    "Long forms, no search or responsive layout, hidden terms, registration, weak product pages, cart and checkout — an e-commerce UX checklist without “fix it and instantly 2×”.",
  lead: [
    ...
    "Below — typical UX mistakes and what to fix. A neighboring piece covers hidden SEO/catalog misses separately; here the focus is the path to purchase. “18 mistakes” is a list guide — not a magic number.",
  ],
  faq: [
    {
      q: "How is this different from the 7 optimization mistakes article?",
      a: "That one — duplicates, filters, catalog pop-ups. This one — search, product page, cart, checkout, and trust on the order path.",
    },
    {
    ...
    },
    {
      ...
      a: "Not required. First a decent responsive site; an app — if you have repeat buys and resources to support it.",
    },
    {
    ...
    {
      q: "When to show price with shipping?",
  ...
  sections: [
    {
      ...
      paras: [
        ...
        "Without mobile-friendly you lose a large share of visits. Responsive beats a “mandatory app”.",
        "Payment, shipping, and warranty terms — visible and in checkout. Contacts and hours raise trust even without an offline point.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "A product with no real description and blurry photos doesn’t compete. Need specs in plain language, stock/lead time, several angles or video.",
        "Cross-sells fit as “similar/related”, not a wall of pop-ups. The cart shouldn’t empty on page refresh; cart lines need a short description and price.",
        "After order — a clear next step: order number, when you’ll contact, timing and payment. Quick order (name + phone) for people who don’t want a long checkout.",
      ],
      links: [
        {
          label: "Product page",
    ...
    },
    {
      ...
      paras: [
        ...
        "The total should update when shipping/payment changes; hidden fees on the last step are classic drop-off. Duplicate the order to the buyer’s email.",
      ],
      notes: [
        {
          title: "Fix priority",
          text: "First mobile checkout, transparent price/shipping, and cart persistence. “Average ticket” widgets — after the purchase path is stable.",
          kind: "tip",
        },
      ],
      links: [
