...
export const kognitivnyeIskazheniyaEn: BlogPost = {
  ...
  lead: [
    "Buyers rarely choose in a perfectly rational way. Decisions are shaped by brand familiarity, fear of missing out, the set of prices on the shelf, and how the promise is worded.",
    "Below — six well-known effects and how to apply them ethically: explain value more clearly, honestly remove risk, help compare packages. Don’t copy CTR/reach figures from old reviews as a norm — run your own tests. Fake urgency and hidden terms hit trust and reputation.",
  ],
  faq: [
    {
      q: "Is this about “tricking” the client?",
    ...
    },
    {
      ...
      a: "Familiar products/brands get more trust. Repeat touches (content, retargeting) work if they don’t spam.",
    },
    {
      q: "Why is “fear of loss” stronger than gain?",
    ...
    {
      q: "Why three plans instead of two?",
      a: "Compromise effect: the middle option often feels “sensible”. Don’t inflate the extremes artificially to absurdity — people notice.",
    },
    {
      q: "What is framing?",
      a: "The same substance in different wording is perceived differently. Tell the truth, choosing a “gain / risk” angle — don’t distort facts.",
    },
    {
      q: "IKEA effect in digital?",
  ...
  sections: [
    {
      ...
      paras: [
        ...
        "Loss aversion: people react more to “miss out” than to a symmetric “get”. Working moves — a trial period, a real limited promo, a clear bonus before the deadline. A timer fits only if the promo truly ends.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      paras: [
        ...
        "Framing: wording changes choice with the same math (“save 200” vs “400 will die”). In ads: stress purchase benefit or the cost of inaction — without distorting facts or scaring for clicks.",
        "IKEA effect: taking part in build/setup raises value. Configurators, package picks, customizing a letter/report — fitting formats.",
      ],
      notes: [
        {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "A separate block — signals that make someone ready to risk money: a tidy site, speed, clear contacts, return terms, payment/security marks. Without those even a strong offer stalls.",
