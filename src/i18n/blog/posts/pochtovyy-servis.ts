...
export const pochtovyyServisEn: BlogPost = {
  ...
  faq: [
    ...
    {
      q: "When do you need temporary mail?",
    ...
    },
    {
      ...
      a: "An address `name@yourfirm.com` on your domain via hosting / Workspace / Yandex 360 and peers. For a brand it’s better than a free `@mail…` on a business card.",
    },
    {
      q: "How not to lose access?",
      a: "Two-factor auth, backup email/phone, a unique password, session checks. Don’t keep the password only in the browser without a manager.",
    },
  ],
  sections: [
    {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Look past “pretty themes” at security, anti-spam, search, the mobile app, attachment/cloud limits, and which other services are tied to the account.",
      ],
      lists: [
        {
          intro: "Checklist:",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Yandex Mail and Mail.ru are a familiar contour in Russia: signup, filters, cloud, ecosystem ties. Interfaces have updated; 2018 screenshots aren’t a guide.",
    ...
    },
    {
      ...
      paras: [
        ...
        "For any inbox: unique password, 2FA, device checks, caution with attachments and phishing “logins.” A mail hack = access to every linked service.",
      ],
      lists: [
        {
