...
export const linkbilderEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — what the specialist does, which skills matter, and how the role differs from “buy 100 links on an exchange”. Paid placement risks are in a separate article; manual publisher search is in the outreach post. This material does not teach how to bypass search-engine rules.",
  ],
  faq: [
    {
      q: "Is a link builder the same as an SEO specialist?",
      a: "They often overlap. SEO is broader (tech, content, semantics). A link builder goes deeper on external placements and negotiation; in small teams it’s one role.",
    },
    {
    ...
    },
    {
      ...
      a: "No. Links are one factor. Site prep and core ranking growth are separate horizons (TOP is planned over months of systematic work).",
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "White and grey contours differ a lot. What usually makes sense: niche media and blogs, partner pieces, meaningful mentions in video/podcasts, company listings. Forum signature spam and one-day directories — noise and risk.",
    ...
    },
    {
      ...
      paras: [
        ...
        "Search visibility timelines are separate from the publish date: site prep and core ranking growth take months of systematic work — links alone don’t “turn on TOP tomorrow”.",
      ],
    },
  ],
  closing: [
