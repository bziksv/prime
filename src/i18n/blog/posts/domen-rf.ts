...
export const domenRfEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — a short history, common myths, and practical SEO tips. General TLD levels live in the first-level domain article.",
  ],
  faq: [
    {
    ...
    {
      q: "What is punycode?",
      a: "The Latin encoding of a Cyrillic name (starts with `xn--…`). You’ll see it in certificates, logs, and some emails.",
    },
    {
      q: "Do you need a mirror `.ru`?",
      a: "Often handy: brand on `.рф` + familiar `.ru` with a canonical redirect to one address.",
    },
    {
      q: "Is SSL hard?",
      a: "Modern certificates support IDN. The key is issuing the cert for the punycode/name correctly and setting https.",
    },
    {
      q: "Should you put a keyword in `.рф`?",
      a: "A short clear name helps. A long “keyword-with-hyphens” name usually loses to a brand.",
    },
    {
      q: "Can you use `.рф` for email?",
      a: "Technically possible, but not equally convenient in every client and system. Before corporate mail launch, test send/receive with key contacts.",
    },
    {
      q: "Should you move an existing `.ru` site to `.рф`?",
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "“Cyrillic isn’t indexed” — outdated. “You’ll always lose to `.ru`” — not a hard rule. “A keyword in `.рф` = TOP” — also a myth: the zone doesn’t replace semantics, tech quality, and useful pages.",
        ...
        "Don’t tie a zone change to a promise of fast growth. SEO prep — audit, tech, semantics, texts, and analytics — takes weeks or about a month; getting the core into the TOP is planned for 2–6 months of work and depends on competition.",
      ],
      lists: [
        {
          intro: "What matters more than the zone:",
          items: [
            "landing quality and the query core;",
      ...
      notes: [
        {
          title: "Timelines",
          text: "Choosing a zone is part of site prep. Getting a commercial core into the TOP is planned months of work — not a consequence of `.рф` or `.ru`.",
        },
      ],
    },
    {
      ...
      level: 2,
      paras: [
        "Check how the name looks in email, messengers, CRM, and ad cabinets. Punycode can scare beginners, so use one clear spelling in docs and ads and briefly explain it when needed.",
