...
export const podderzhkaYandeksEn: BlogPost = {
  ...
  lead: [
    "Yandex support helps with ecosystem products: Mail, Webmaster, Direct, Metrica, and more. It is not a “team that manually ranks you TOP”: on ranking they usually give diagnostics and policy links — not a manual boost.",
    "Below — where to go (Help → form), what to write, typical webmaster cases (index, mirrors, migration), and how not to waste a ticket. UIs and phone numbers change — use the official “Write” buttons and chats in Yandex Help at the time you contact them.",
  ],
  faq: [
    {
      q: "Will support put the site in TOP?",
      a: "No. They fix product issues, explain Webmaster statuses, help with migration/security. Rankings come from site quality and time; planned TOP for the core is often 2–6 months after work starts.",
    },
    {
      q: "Who is Platon Shchukin?",
      a: "A historical “face” of Yandex support/help replies. Today it’s more often a chatbot and forms; same idea — gather data and route to a human or an article.",
    },
    {
      q: "Help first or a ticket right away?",
      a: "Search Help and product statuses first. A ticket when self-checks are exhausted and you have a reproducible case.",
    },
    {
      q: "Which phone to call?",
    ...
    {
      q: "What to attach?",
      a: "URL, problem start date, what you already tried, screenshots of errors/Webmaster reports, browser and OS for UI bugs.",
    },
    {
      q: "Should you write about filters and “competitors colluded”?",
    ...
    },
    {
      ...
      a: "Yes — products have their own help tracks. For index and search messages — via Help/form tied to Webmaster and a verified site.",
    },
    {
      q: "How long to wait for a reply?",
  ...
  sections: [
    {
      ...
      level: 2,
      paras: [
        "A ticket fits a product bug, unclear cabinet status, security, domain migration, tool errors. “Not in TOP-10” with no technical signals — audit and content first, not search support.",
      ...
      notes: [
        {
          ...
          kind: "tip",
          text: "Writing “the site isn’t ranking, do something” with no URL, dates, or cabinet screenshots.",
        },
      ],
    },
    {
      ...
      level: 2,
      paras: [
        "Login, mail, spam, filter issues — via Mail Help and the feedback form. Before a ticket check password/2FA, another device, Spam folder, blockers.",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "For a site, verify ownership in Yandex Webmaster. Typical topics: indexing, security, region, preferred host, domain move, odd snippets. Cabinet reports first — then the help form for that question branch.",
    ...
    },
    {
      ...
      paras: [
        ...
        "Expecting manual ranking is a common trap. Site prep — weeks; visibility for the core builds month to month.",
      ],
      lists: [
        {
      ...
      notes: [
        {
          title: "Timelines",
          kind: "tip",
          text: "A support reply ≠ hitting TOP. TOP for the core is a separate horizon after work on the site.",
        },
      ],
    },
  ],
