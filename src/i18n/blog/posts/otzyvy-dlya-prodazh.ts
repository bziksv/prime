...
export const otzyvyDlyaProdazhEn: BlogPost = {
  ...
  excerpt:
    "The trust threshold for reviews, the link to local SERP and maps, how to ask for reviews and handle negatives — without fake ratings or “bought five-stars”.",
  lead: [
    "Before choosing a clinic, cafe, or service, people read reviews on maps, directories, and the site. An empty profile at a fair price and convenient address often loses to a competitor with a living rating history.",
    "Below — review-count guides from industry research, why replies and platform diversity matter, and how to run reviews legally. Figures aren’t a “TOP formula” — they’re a trust threshold; map and aggregator rules change.",
  ],
  faq: [
    {
      q: "Is there a magic review number?",
      a: "No universal one. Local-market studies often cite a threshold around ~40 reviews for noticeable trust, and dozens on average for the local pack. In niches with rare purchases, fewer can suffice; in HoReCa the “norm” is higher.",
    },
    {
    ...
    },
    {
      ...
      a: "They don’t replace “commercial ranks” directly. Indirectly — awareness, links from profiles/directories, trust, and conversion. Site prep and core ranking buildup are separate horizons.",
    },
    {
      q: "What to reply to a negative?",
    ...
    },
    {
      ...
      a: "A discount/bonus “for an honest review” is sometimes allowed by platform policy — check the rules. You can’t pay only for a five-star or dictate the text.",
    },
  ],
  sections: [
    {
      title: "Why business needs reviews",
      level: 2,
      paras: [
        ...
        "Yandex Maps and Google, 2GIS, niche review sites, and social networks create a path “found → read → called/went”. Without reviews you look like an empty shell even if the product is strong.",
      ],
      lists: [
        {
          intro: "What reviews strengthen:",
          items: [
      ...
      lists: [
        {
          ...
          items: [
            "0–5 — “almost no history”, high walk-away risk;",
            "dozens — a trust threshold for many niches;",
            "hundreds — normal for cafes/chains where people review often;",
      ...
      tables: [
        {
          ...
          rows: [
            ...
            ["HoReCa / neighborhood retail", "Steady inflow; watch the rating"],
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "In local SERP, people often click the map block harder than the organic “tail”. The average-rating gap between places 1–3 and 8–10 may be tenths of a point, but clicks and calls go to the top of the pack.",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "First lock profiles on Yandex Maps / Google Business Profile (and 2GIS if relevant): one profile per branch. Then simplify leaving a review on the site (block by service/product or a dedicated page) and plug in mention monitoring.",
        "Ask after a successful outcome: SMS/email with a map link, a QR in the venue, a soft ask from the manager. Incentives — only if the platform allows them and they don’t buy the rating.",
      ],
      lists: [
        {
          intro: "Mini process:",
          items: [
            ...
            "an owner watches new reviews daily/every other day;",
            "reply templates for typical negatives + escalation;",
            "a review ask in the “client is happy” script;",
            "once a quarter — complaint themes for the product.",
          ],
        },
      ],
      links: [
    ...
    },
    {
      ...
      lists: [
        {
          intro: "Negative-reply algorithm:",
          items: [
            "thank them for the feedback;",
            "acknowledge the problem without “everything is perfect” excuses;",
            "offer a channel to resolve (phone, DM);",
            "after resolution — briefly note the outcome in the thread if fitting;",
            "don’t fight publicly over small stuff at the cost of reputation.",
          ],
        },
      ],
      notes: [
        {
          title: "SEO timelines",
          kind: "tip",
          text: "Reviews speed choice on maps. Site prep for promotion — about a month; core TOP buildup planned 2–6 months after work starts — a separate track.",
        },
      ],
    },
    {
      ...
      level: 2,
      paras: [
        "Review sites and directories sometimes rank for “reviews + brand/service” — extra traffic to the profile. Correct profiles give consistent NAP and sometimes a site link; that’s no reason to spam directories for “link mass”.",
        "Don’t buy “100 reviews” packs, don’t keyword-stuff the profile name, don’t clone branches. Focus — real clients, replies, and service.",
      ],
      lists: [
        {
          intro: "Red flags:",
          items: [
            ...
            "a review spike in a day with no promo/event;",
            "banning negatives in promo rules;",
            "agencies promising “maps TOP in a week via reviews”.",
          ],
        },
      ],
      links: [
