...
export const bitrixPlyusyMinusyEn: BlogPost = {
  ...
  excerpt:
    "Pros and cons of 1C-Bitrix: ecosystem, security, licenses, hosting, and speed — who the platform fits, without 2017 rankings and the “Bitrix = TOP” myth.",
  lead: [
    ...
    "1C-Bitrix is powerful for complex RU catalogs and integrations — and heavy for a simple brochure site. Skip the “forever #1” cult and outdated local price quotes; check current editions on the vendor site. Comparing engines for online stores is a separate piece.",
  ],
  faq: [
    {
    ...
    {
      q: "Does Bitrix’s popularity mean it’s the best choice?",
    ...
    },
    {
      ...
      a: "No. A CMS does not replace semantics, content, and tech work. Prep and launch ≠ TOP-10; core rankings are planned over months of work (typically 2–6 months after work starts).",
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Gather requirements: catalog, 1C, roles, integrations, who admins, 1–2 year budget. Compare alternatives (WordPress/Woo, OpenCart, custom) on TCO and support risk.",
