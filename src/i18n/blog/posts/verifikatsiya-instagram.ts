...
export const verifikatsiyaInstagramEn: BlogPost = {
  ...
  lead: [
    "The blue check confirms the profile represents a notable person, brand, or organization — not a scam clone. It doesn’t turn on a “TOP mode” and doesn’t replace content, offer, and ads.",
    "When the status helps, how classic requests differ from paid Meta Verified, and what to expect from reach — without buying a “turnkey check.” Menu items and products change; check Meta Help. See the disclaimer on this page.",
  ],
  legalNotice: {
    title: "Dear readers!",
      ...
      notes: [
        {
          ...
          title: "Myth",
          paras: [
            "“Badge = unlimited Stories links” is an outdated pairing. Link-sticker access hasn’t equaled verification alone for a long time; check current rules.",
          ],
        },
      ],
      links: [
