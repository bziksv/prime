...
export const podryadchikKontekstEn: BlogPost = {
  ...
  title: "How to choose a contextual advertising contractor",
  date: "2018-12-06",
  ...
  lead: [
    ...
    "We cover what to watch in analytics, how to count payback and customer cost, which brief and reporting to set, and which exceptions show up in the first months. Finding a marketer in general is a separate piece; here the focus is controlling paid search itself.",
  ],
  faq: [
    {
    ...
    },
    {
      ...
      a: "The first weeks are data and fixes. If after 2–3 months with a clear brief and budget there’s no movement toward KPI — review hypotheses and the contractor.",
    },
    {
    ...
    },
    {
      ...
      a: "Access, scope of work, lead/KPI definitions, report deadlines, budget rules. A “TOP guarantee” with no metrics is empty noise.",
    },
  ],
  sections: [
    {
    ...
    },
    {
      ...
      paras: [
        ...
        "For repeat purchases compare CPA with LTV (lifetime value), or gross profit per customer over the horizon you actually see. “CPA well below LTV” depends on margin; the “three times” rule from old guides is a rough heuristic, not law.",
      ],
      lists: [
        {
