...
export const antitrendyMarketingaEn: BlogPost = {
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Mass promo SMS often feel like spam: no context, hard to pack value into a short line, weak link clicks. The channel isn’t dead for transactions and an explicit opt-in base — but as the main “cold marketing” — it’s an anti-trend.",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Template “catalog smiles” and someone else’s offices don’t build trust. If stock is inevitable — pick non-obvious frames and don’t reuse the shot ten competitors already run. Stronger: your product, team, process photos.",
        "One-touch selling to a stranger works less often: choice is wide, error risk is high. You need differentiation (UVP), useful touches, and service — not “buy now” pressure in the first message.",
      ],
      lists: [
        {
