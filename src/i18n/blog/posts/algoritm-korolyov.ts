...
export const algoritmKorolyovEn: BlogPost = {
  ...
  excerpt:
    "What the 2017 “Korolyov” algorithm announced after “Palekh”, why Yandex pushed neural nets in search, and the lasting SEO takeaway: page meaning and usefulness beat keyword nausea.",
  lead: [
    ...
    "Below — what was promised then, how to read it today, and what specialists should focus on. Update names change; the logic “answer intention with useful content” does not.",
  ],
  faq: [
    {
      q: "What is “Korolyov”?",
    ...
    },
    {
      ...
      a: "No. Keywords and clusters are still needed to understand demand. But sheets of exact matches and “nausea for nausea’s sake” stopped being the main bet even then.",
    },
    {
    ...
    {
      q: "Link to LSI copywriting?",
      a: "In practice — covering the topic with related concepts and questions, not density of one keyword. See SEO copywriting.",
    },
    {
      q: "When to expect TOP after “semantic” copy?",
      a: "Prep — weeks. Core rank buildup planned 2–6 months. One update doesn’t put a site in TOP overnight.",
    },
    {
      q: "Where to see Yandex/Google differences?",
      ...
      lists: [
        {
          intro: "Line context:",
          items: [
            "“Palekh” — meaning/titles on a narrower contour;",
