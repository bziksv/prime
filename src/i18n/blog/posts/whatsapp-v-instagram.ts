...
export const whatsappVInstagramEn: BlogPost = {
  ...
  lead: [
    ...
    "Use the `wa.me` format with optional prefilled text, know when a Call button is enough, and don’t stack a dozen link-in-bio services. Menu labels change; check Meta Help. Disclaimer is on the page.",
  ],
  legalNotice: {
    title: "Dear readers!",
  ...
  sections: [
    ...
    },
    {
      ...
      paras: [
        ...
        "Encode spaces and non-Latin characters (`%20`, or encode in any URL encoder). Don't make a wall — 1–2 sentences are enough.",
