...
export const wordpressSeoPlaginyEn: BlogPost = {
  ...
  lead: [
    "The WordPress catalog has tens of thousands of extensions; for SEO a small stack is enough: one main SEO suite, plus point tools for speed, redirects, and media. Extra plugins raise breach and slowdown risk.",
    "Below — plugin groups with popular examples and selection rules. Names and plans change — check current features in the official catalog. A plugin doesn’t replace semantics, copy, or time for ranking buildup.",
  ],
  faq: [
    {
    ...
    },
    {
      ...
      a: "Usually 1 suite + 2–4 point tools (redirects, cache/optimize, image compression, broken links on a schedule).",
    },
    {
    ...
    },
    {
      ...
      a: "No. It’s setup convenience. Site prep — about a month; core ranking buildup planned 2–6 months after work starts.",
    },
  ],
  sections: [
    {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Yoast SEO, All in One SEO (AIOSEO), Rank Math, and The SEO Framework cover the usual set: title/description, XML sitemap, noindex, social previews, often schema and search-panel integrations. Rank Math and AIOSEO are strong on redirects and stores; The SEO Framework leans quieter and more automatic.",
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "HREFLANG Tags Lite and peers matter if you truly have several languages/regions. Comment anti-spam plugins cut junk and moderation load — hygiene, not a direct SEO factor.",
      ...
      notes: [
        {
          title: "Timelines",
          kind: "tip",
          text: "Installing plugins takes hours. Site and content prep — weeks–month; TOP for the core planned 2–6 months after work starts.",
        },
      ],
      links: [
        {
