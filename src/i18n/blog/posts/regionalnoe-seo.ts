...
export const regionalnoeSeoEn: BlogPost = {
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "In many niches, clicks from the local pack and map cards matter as much as classic organic blues. Create and verify profiles; keep hours, photos, and review replies current.",
