...
export const metaDescriptionEn: BlogPost = {
  ...
  lead: [
    "`<meta name=\"description\" content=\"…\">` is a short page summary for search engines and sometimes social. It’s not a secret TOP-1 factor — it’s a candidate for the snippet under the title in results.",
  ...
  faq: [
    {
      q: "Does description directly raise rankings?",
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "In the CMS — a separate SEO description field on templates and key landings. Templates with product/city placeholders are fine if the phrase reads naturally — not “Buy {name} {name} price”.",
