...
export const sermEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — when SERM fits and how to build strategy ethically. Mass posting of paid “positive” reviews and burying the truth risks reputation and platforms; focus on facts, service, and strong owned URLs.",
  ],
  faq: [
    {
      q: "Is SERM = faking good reviews?",
    ...
    {
      q: "How is it different from ORM?",
      a: "ORM is reputation across all channels (reviews, media, social, maps). SERM focuses on the search SERP for brand queries.",
    },
    {
      q: "When to start?",
      a: "When notable negativity sits in TOP, competitors attack, a crisis hits, or the brand is “empty” in search and third-party sites replace you.",
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "SERM signals: dense negativity in TOP for the brand; a crisis/rumor that outran the rebuttal; a quiet niche with no owned properties in SERP; a wave of similar reviews that looks like an attack.",
      ...
      lists: [
        {
          ...
          items: [
            ...
            "plan to close real service claims;",
