...
export const analitikaKontentMarketingaEn: BlogPost = {
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Business layer: leads, signups, demos, purchases attributed to content. You need analytics goals and an agreed attribution model (at least last click + common sense on assisted).",
    ...
    },
    {
      ...
      paras: [
        ...
        "ROI is rough: (value of results − cost) / cost, or cost per content lead vs other channels. Imperfect numbers — but they cut the illusion of a “free” blog.",
      ],
      lists: [
        {
          intro: "Ops:",
    ...
    },
    {
      ...
      paras: [
        ...
        "For SEO pieces set a horizon: prep and publish — weeks; building rankings and steady traffic — planned months (often 2–6 after work starts), not “article live — instant TOP”.",
      ],
      lists: [
        {
          intro: "Report ritual:",
