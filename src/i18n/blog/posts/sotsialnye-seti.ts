...
export const sotsialnyeSetiEn: BlogPost = {
  ...
  excerpt:
    "What social networks are: a short history, platform types, upsides and risks, trends without outdated “TOP-10 MAU” lists or dead Google+. Meta* disclaimer on the page.",
  lead: [
    ...
    "Below — where social networks came from, how they differ by job, why they hold attention, which risks to plan for, and where audience attention is shifting. We don’t copy 2021–2022 MAU rankings: platforms and laws change. Meta* disclaimer is on the page.",
  ],
  legalNotice: {
    title: "Dear readers!",
  ...
  faq: [
    ...
    {
      q: "Does business need every major platform?",
    ...
    },
    {
      ...
      a: "Audience, ad cabinets, rules, and availability. Choose for geography and legal context — not someone else’s “world TOP.”",
    },
    {
      q: "Do social networks kill the site?",
      a: "No. The site is the base for SEO, trust, and conversion; networks are traffic and dialogue. You need the link between them.",
    },
  ],
  sections: [
    {
      ...
      paras: [
        ...
        "In the 2000s came business and media networks, then mass chat and video platforms. In the Russian-speaking segment VK and Odnoklassniki grew separately; later — photo/video formats and short clips.",
        "Important: the landscape didn’t freeze. Platforms get bought, closed, change algorithms and ad rules — business strategy should rest on the current audience, not nostalgia for a “golden year.”",
      ],
      lists: [],
    },
    {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Easy conversation without distance, a familiar mobile UI, fast access to news and entertainment, finding people and communities by interest.",
    ...
    },
    {
      ...
      paras: [
        ...
        "Mitigation: strong passwords and 2FA, minimal extra data in the profile, moderation, owned channels (site, email, CRM) — don’t keep the only “truth about the company” only on social.",
      ],
      lists: [],
      links: [
        {
    ...
    },
    {
      ...
      paras: [
        ...
        "Mind the legal status of platforms in your jurisdiction and whether ad cabinets exist. Strike dead services (like closed Google+) from old rankings.",
      ],
      lists: [],
      notes: [
        {
    ...
    },
    {
      ...
      paras: [
        ...
        "Bake data and reputation risks into the process the same way you bake a content plan.",
      ],
      lists: [],
    },
  ],
