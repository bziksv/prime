...
export const dlinaSeoTekstaEn: BlogPost = {
  ...
  lead: [
    "Optimal SEO text length is not a universal brief number like “2,000 characters for everyone”. A product card needs a short description; a commercial service and a guide need different volumes. Close the intent and don’t lose on answer completeness to strong SERP pages.",
    "Below — why size matters at all, how to take a guide from the TOP-10, when a long-read fits, and which text qualities beat a character counter. Volume without uniqueness, structure, and usefulness doesn’t save ranks.",
  ],
  faq: [
    {
    ...
    {
      q: "If the text is shorter than competitors’, is TOP impossible?",
      a: "Not always. Shorter but more precise and usable often beats 15,000 characters of fluff. A TOP guide is a hypothesis, not a law.",
    },
    {
      q: "How much to write on a product card?",
    ...
    },
    {
      ...
      a: "Only if the information is useful and structured. Otherwise bounce and fluff/nausea grow.",
    },
    {
    ...
    {
      q: "Should you exceed the TOP average by 500 characters?",
      a: "Not as a rule. Better add facts, trust blocks, and answers to questions than pad water to a quota.",
    },
    {
    ...
    {
      q: "Does volume equal a fast TOP?",
      a: "No. Text is one work layer. Site prep — about a month; core ranking buildup planned 2–6 months after work starts.",
    },
  ],
  sections: [
    {
      ...
      paras: [
        ...
        "Literacy, low fluff, adequate keyword density, and live expert facts often decide more than racing “competitor has 4,500 — we write 5,000”. Don’t proliferate empty template pages: delete or close them if there’s nothing to fill.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Take a guide from the SERP, write no worse on meaning, measure. Don’t promise yourself TOP only because character count grew. Content and tech prep — weeks or about a month; core visibility builds planned over months (often 2–6 after work starts).",
