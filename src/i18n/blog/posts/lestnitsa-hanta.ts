...
export const lestnitsaHantaEn: BlogPost = {
  ...
  lead: [
    ...
    "The idea is simple: you can’t hard-sell someone who doesn’t see the job yet. Below — the steps and what to do on each in copy, ads, and scripts.",
  ],
  faq: [
    {
  ...
  sections: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "A strong longread or landing can walk several steps in a row: pain → options → why this approach → why you → action. The main thing — don’t open with price for people who don’t get the job yet.",
