...
/** EN overlay for pokupka-ssylok — same structure as RU JSON. */
export const pokupkaSsylokEn: BlogPost = {
  slug: "pokupka-ssylok",
  title: "Buying links: risks and quality criteria",
  date: "2021-02-05",
  category: "SEO",
  ...
  faq: [
    ...
    {
      q: "Are exact-match anchors required?",
  ...
  sections: [
    {
      title: "What makes a link useful",
      level: 2,
      paras: [
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Look at audience, editorial standards, outbound links, and domain history. Skip sites that sell a “100-link pack” with no article.",
        "Ask for past publish examples and clear terms. If the page is a pile of unrelated ad links and content never updates — value is doubtful even with “pretty” 2015-era metrics.",
      ],
      lists: [
        {
          intro: "Red flags:",
    ...
    },
    {
      ...
      lists: [
        {
          intro: "Mini report per placement:",
          items: [
            "platform and piece",
      ...
      tables: [
        {
          ...
          headers: ["Approach", "Benefit", "Risk"],
          rows: [
            ["Exchange pack", "Cheap and fast on paper", "Filters, junk profile"],
            ["Selective article", "Audience and context", "Costlier and slower"],
            ["PR / partnership", "Brand and trust", "Needs a strong news hook"],
          ],
        },
      ],
    },
