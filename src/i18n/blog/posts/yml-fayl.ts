...
export const ymlFaylEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — why YML instead of manual spreadsheets, what the feed contains, and how to build and refresh it. Market account menus change — check current Yandex help.",
  ],
  faq: [
    {
      q: "YML, CSV, or XLS?",
      a: "For a small manual catalog a spreadsheet can be enough. At hundreds of SKUs YML is easier: auto-refresh from CMS/ERP and richer attribute fields.",
    },
    {
      q: "One feed for every marketplace?",
      a: "The base can be shared, but fields and categories differ by platform. Teams often keep one source and separate exports/mapping. See Market alternatives.",
    },
    {
      q: "How often to update the price list?",
    ...
    {
      q: "Do you need to write XML by hand?",
    ...
    },
    {
      ...
      a: "Empty required fields, broken links/photos, wrong categories, price/stock “from the past”, forbidden wording in the title.",
    },
    {
      q: "Is YML the same as a Turbo feed?",
      a: "No. YML is a product price list for Market/ads. Turbo was a separate accelerated-pages story — and that product format is outdated.",
    },
    {
      q: "Where to see errors?",
      a: "In the partner/Market account after feed upload and in moderation emails. Fix the data source, not only “the file on disk”.",
    },
  ],
  sections: [
    {
      ...
      paras: [
        ...
        "The feed is the bridge between your inventory system and the platform storefront: update price on site/warehouse → file updates → listing updates.",
      ],
      lists: [
        {
          ...
          items: [
            ...
            "XLS/spreadsheet — easy to edit by hand on a small set;",
    ...
    },
    {
      ...
      paras: [
        ...
        "Exact required fields and schemas (simplified/custom type) are in current Yandex docs — requirements keep expanding.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      paras: [
        ...
        "Keep one source for prices and stock. Site/feed mismatch hurts trust more than missing another marketplace.",
      ],
      links: [
        {
