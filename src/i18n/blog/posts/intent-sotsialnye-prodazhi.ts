...
export const intentSotsialnyeProdazhiEn: BlogPost = {
  ...
  lead: [
    ...
    "Intent types shape how you reply without spam — and this is not the same as SEO user intent (search-query intent). Informational only; some foreign platforms are restricted in Russia — use lawful channels (including VK) and follow platform rules. Handle personal data and chats per the law.",
  ],
  faq: [
    {
      q: "Is this the same as SEO user intent?",
      a: "No. SEO intent is what someone wants from a search query. This covers intent in a social post/comment.",
    },
    {
    ...
    },
    {
      ...
      a: "No. Hot and relevant ones — yes, fast and clearly. Cold wishes with no budget often don’t convert.",
    },
    {
  ...
  sections: [
      ...
      lists: [
        {
          ...
          items: [
            ...
            "handoff to a colleague with expertise;",
    ...
    },
    {
      ...
      paras: [
        ...
        "Geo, categories, and excluded topics cut noise. Auto-rules help for typical replies; complex cases need a human.",
      ...
      notes: [
        {
          title: "Platforms",
          text: "This article may mention Facebook* and Instagram* (Meta* products). In Russia, Meta’s activity is recognized as extremist; use available lawful channels. The page disclaimer is required.",
          kind: "tip",
        },
      ],
      links: [
  ...
  closing: [
    "Intent in social is an early demand signal if the team replies fast, clearly, and without spam. Don’t confuse it with SEO query intent: there it’s a page for the SERP; this covers dialogue and CRM.",
  ],
  related: [
    "user-intent",
    "retargeting",
