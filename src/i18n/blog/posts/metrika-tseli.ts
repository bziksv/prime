...
export const metrikaTseliEn: BlogPost = {
  ...
  lead: [
    ...
    "Goal types, when to pick which, how to set a URL condition and an event via `reachGoal`, how to build a multi-step funnel, and how to verify firing. Counter install is a separate piece.",
  ],
  faq: [
    {
    ...
    {
      q: "Why isn’t my Metrica goal counting?",
