...
export const kommercheskoePredlozhenieEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — types by audience “temperature”, working structures, and how to write the headline, offer, benefits, and price. Blasts to bought lists and aggressive spam are out of bounds; write on point and only where you were asked or have a lawful basis to contact.",
  ],
  faq: [
    {
      q: "Is a proposal just any promo email?",
    ...
    },
    {
      ...
      a: "Cold — little context, shorter, benefit “from the door”. Hot — after talks: timing, scope, price, next step personalized.",
    },
    {
      q: "Do you need a price in a cold proposal?",
      a: "Often yes — at least a range or packages. Hiding price to force a lead form filters worse and annoys more.",
    },
    {
      q: "Can you write “best”, “cheapest of all”?",
    ...
    {
      q: "Is a USP required?",
      a: "Useful to state how you differ for this audience. A USP with no link to the client’s pain is just a slogan.",
    },
  ],
  sections: [
    {
    ...
    },
    {
      ...
      paras: [
        ...
        "Don’t pressure or decide for the client. The job is clear information; the decision stays theirs. Fewer judgments (“better”, “cheaper”), more checkable differences.",
      ...
      notes: [
        {
          title: "Legal outline for outreach",
  ...
  closing: [
    "A strong proposal matches audience temperature, answers “why me” fast, and honestly names price and the next step. Build the structure once — then adapt blocks for cold, warm, and hot clients.",
  ],
  related: [
    "utp",
    "kopirayting",
