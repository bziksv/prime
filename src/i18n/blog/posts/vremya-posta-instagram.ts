...
export const vremyaPostaInstagramEn: BlogPost = {
  ...
  lead: [
    ...
    "Below: how to read audience activity, test slots, and not confuse timing with content quality. Schedulers are covered in a separate article. The Meta disclaimer is on the page.",
  ],
  legalNotice: {
    title: "Note",
  ...
  faq: [
    {
      ...
      a: "No. Check “when your followers are online” in professional Insights and compare it with publish times on your strongest posts.",
    },
    {
      ...
      lists: [
        {
          intro: "Mini method:",
          items: [
            "list your 10 strongest posts by saves and replies",
      ...
      notes: [
        {
          ...
          kind: "tip",
          text: "Gray auto-poster catalogs with passwords and “auto-likes” risk account limits. Schedule content with legitimate tools.",
        },
      ],
    },
    {
