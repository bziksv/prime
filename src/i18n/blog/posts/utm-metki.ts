...
export const utmMetkiEn: BlogPost = {
  ...
  lead: [
    ...
    "Below — tag structure, required and optional fields, naming rules, and common mistakes. Link builders speed typing, but you own the value convention.",
  ],
  faq: [
    {
      q: "What is UTM?",
      a: "Parameters like utm_source, utm_medium, utm_campaign in the link query string. The counter reads them and splits the visit by sources/campaigns.",
    },
    {
    ...
    {
      q: "Need UTM for organic?",
      a: "No: search passes the channel itself. UTM is for ads, emails, posts, partners — where the source would otherwise blur.",
    },
    {
      q: "Do Metrica and GA read UTM the same?",
      a: "Both understand the standard. Reports and groupings differ — compare trends inside one system.",
    },
    {
      q: "Can UTM use Cyrillic?",
      a: "Prefer Latin and translit: fewer encoding surprises and duplicates like “Yandex” vs “yandex”.",
    },
    {
      q: "How does medium=cpc differ from cpm?",
      a: "cpc — pay per click (search/context), cpm — pay per impressions (display). email, social, referral — other channel types.",
    },
    {
      q: "Do UTM tags hurt SEO?",
      a: "Keep a clean URL in the index on canonical landings; UTM belongs on ad/email links. Canonical and consistency matter.",
    },
    {
      q: "Need your own generator?",
      a: "Handy at volume. The key is one value dictionary in the campaign table — not every manager inventing anew.",
    },
  ],
  sections: [
    {
    ...
    },
    {
      ...
      paras: [
        ...
        "Ad templates often use cabinet substitutions (dynamic parameters) that insert campaign/ad IDs on click. Keep the static part (source/medium/names) in one style anyway.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "**utm_term** — usually the keyword/targeting audience. Handy in search if the cabinet doesn’t pass the keyword otherwise.",
        "**utm_content** — distinguish ads, banners, email buttons (`banner-a`, `cta-green`). A/B creatives show up in analytics, not only in the ads cabinet.",
      ],
      lists: [
        {
    ...
    },
    {
      ...
      level: 2,
      paras: [
        "Online builders and sheets speed assembly: paste the landing URL and field values — get a finished link. For hundreds of ads you need a template with cabinet auto-substitutions.",
      ...
      notes: [
        {
          title: "Link to SEO",
          text: "UTM alone doesn’t “promote” into TOP. They help evaluate paid and referral traffic. Organic and ranks follow their own rules; prep and visibility buildup are different timelines.",
          kind: "tip",
        },
      ],
      links: [
