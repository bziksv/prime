...
export const blogInteractEn: Record<string, BlogInteractConfig> = {
  ...
  "nazvanie-internet-magazina": {
    checklist: {
      afterTitleIncludes: "How to pick from a shortlist",
      title: "Online store name checklist",
      lead: "Before registering the domain and logo.",
      items: [
        { id: "audience", label: "Name is clear to the target audience" },
        { id: "assort", label: "Tied to assortment / niche" },
        { id: "sound", label: "Easy to say and dictate" },
        { id: "domain", label: "Domain and socials free / aligned" },
        { id: "unique", label: "No confusion with another brand" },
        { id: "length", label: "1–3 words, fits the logo" },
        { id: "survey", label: "Short audience poll done" },
        { id: "spell", label: "Spelling and translit locked" },
      ],
    },
    quizzes: [
      {
        afterTitleIncludes: "Why the name matters for a store",
        title: "Mini quiz: store naming",
        lead: "Two checks.",
        questions: [
          {
            id: "nm1",
            question: "Stuffing “buy … cheap” into the brand…",
            options: [
              "Is required for SEO",
              "Usually hurts trust and sound",
              "Replaces the domain",
            ...
            correct: 1,
            explain: "A brand is about recognition — not a query dump.",
          },
          {
            id: "nm2",
            question: "Before the final name pick…",
            options: [
              "“We like it” is enough",
              "Check domain, search, and an audience poll",
              "Only register a company",
              "Only buy links",
            ],
            correct: 1,
  ...
  "autrich": {
    checklist: {
      afterTitleIncludes: "How to fold it into the SEO plan",
      title: "Outreach checklist",
      lead: "Before a wave of editor emails.",
      items: [
        { id: "base", label: "Your site isn’t raw: tech and strong pages" },
        { id: "list", label: "Donor table with topical fit" },
        { id: "spam", label: "Obvious link spam filtered out" },
        { id: "pitch", label: "Emails personalized per site" },
        { id: "value", label: "Topic helps readers — not “article with a link”" },
        { id: "legal", label: "Ads labeled per site rules" },
        { id: "check", label: "After publish: URL and mention verified" },
        { id: "kpi", label: "KPIs: replies/publishes/traffic — not only links" },
      ],
    },
    quizzes: [
      {
  ...
  "programmy-seo": {
    checklist: {
      ...
      lead: "Before paying for new subscriptions.",
      items: [
        { id: "tasks", label: "Project task list locked" },
        { id: "core", label: "Wordstat + Webmaster/GSC + counter in place" },
        { id: "crawl", label: "Crawler available for your site" },
        { id: "goals", label: "Analytics goals configured" },
        { id: "text", label: "Copy-check tool agreed in the brief" },
        { id: "paid", label: "Paid suites added only for real pain" },
        { id: "table", label: "Table: task → tool → limits" },
        { id: "review", label: "Quarterly audit of unused subscriptions" },
      ],
    },
        ...
        questions: [
          {
            ...
            correct: 1,
            explain: "Tasks and the free track first.",
          },
          {
            id: "ps2",
            question: "Installing SEO software…",
            options: [
              "Guarantees TOP in a week",
              "Speeds data collection; TOP takes months after the work",
              "Replaces semantics",
              "Replaces Metrica",
            ],
            correct: 1,
  ...
  "operatory-poiska": {
    checklist: {
      ...
      items: [
        { id: "site", label: "site: checked on key sections" },
        { id: "title", label: "Suspicious intitle: duplicates pulled" },
        { id: "files", label: "Extra filetype: in the index flagged" },
        { id: "params", label: "Utility inurl: (session/sort) checked" },
        { id: "yandex", label: "Yandex slice cross-checked with Google" },
        { id: "panels", label: "Gaps cross-checked with Webmaster/GSC" },
        { id: "old", label: "Stale related:/cache: not in the strategy" },
        { id: "ticket", label: "Findings turned into fix tickets" },
      ],
    },
    quizzes: [
        ...
        questions: [
          {
            ...
            options: [
              "A full forever list of every site URL",
              "A sample of domain pages in results (an estimate)",
              "A Screaming Frog replacement",
              "A TOP-1 guarantee",
            ],
            correct: 1,
  ...
  "sayty-satellity": {
    checklist: {
      ...
      lead: "Before agreeing to a “farm”.",
      items: [
        { id: "audit", label: "Main site: tech and content in shape" },
        { id: "no-new", label: "No new satellites/doorways planned" },
        { id: "profile", label: "Backlink profile without a dense self-network" },
        { id: "vendor", label: "Vendor doesn’t promise TOP via a domain network" },
        { id: "mentions", label: "Mentions plan: PR/outreach/live sites" },
        { id: "metrics", label: "KPIs: traffic and leads — not count of own domains" },
        { id: "timeline", label: "Timelines: prep ≠ TOP 2–6 months" },
        { id: "exit", label: "If a network exists — unwind plan agreed" },
      ],
    },
    quizzes: [
      {
        ...
        questions: [
          {
            ...
            question: "A satellite network for business…",
            options: [
              "A reliable way to TOP in a month",
              "High risk of filters and losing the main domain",
              "Required for a young site",
              "Replaces semantics",
            ],
            correct: 1,
            explain: "The scheme is manipulative and often punished.",
          },
          {
            id: "sat2",
            question: "Instead of a domain farm, better…",
            options: [
              "Even more lookalike wrappers",
              "Content, tech, and targeted mentions on live sites",
              "Hide owners at any cost",
              "Promise the client TOP in 7 days",
            ],
            correct: 1,
            explain: "Lasting growth without a controlled network.",
          },
        ],
      },
    ],
  ...
  "sayt-ne-v-top": {
    checklist: {
      afterTitleIncludes: "A practical diagnosis order",
      title: "“Why not in TOP” checklist",
      lead: "Go in order.",
      items: [
        { id: "intent", label: "Queries and landings matched by intent" },
        { id: "index", label: "Index and statuses checked in Webmaster/GSC" },
        ...
        { id: "filter", label: "Filter hypothesis checked via dynamics and links" },
        { id: "content", label: "Content closes the query, no thin duplicates" },
        { id: "tech", label: "Speed, mobile, crawl errors closed" },
        { id: "ux", label: "UX and analytics goals look at leads" },
        { id: "secure", label: "No viruses/malicious redirects" },
        { id: "host", label: "Hosting stable, domain without toxic history" },
        { id: "time", label: "Timelines: prep ~1 month, TOP planned 2–6 months" },
      ],
    },
    quizzes: [
      {
        afterTitleIncludes: "Expecting instant TOP",
        title: "Mini quiz: timelines and TOP",
        lead: "Two checks.",
        questions: [
          {
            ...
            options: [
              "Equals hitting TOP-10",
              "Prepares the project for promotion; TOP is a separate horizon",
              "Guarantees first place",
              "Is only for stores",
            ],
            correct: 1,
            explain: "Prep ≠ ranking buildup.",
          },
          {
            id: "top2",
            question: "A planned share of the core in TOP more often…",
            options: [
              "2–3 days after launch",
              "2–6 months after work starts",
              "Only after buying satellites",
              "Instantly with unique copy",
            ],
            correct: 1,
            explain: "Guide 2–6 months, no date guarantee.",
          },
        ],
      },
    ],
  ...
  "yandeks-vebmaster": {
    checklist: {
      afterTitleIncludes: "Settings, support, and place in SEO",
      title: "Yandex Webmaster checklist",
      lead: "After connecting and on ongoing work.",
      items: [
        { id: "verify", label: "Site verified, canonical mirror set" },
        { id: "sitemap", label: "Sitemap added and error-free" },
        { id: "notify", label: "Critical-issue notifications on" },
        { id: "diag", label: "Diagnostics and security reviewed" },
        { id: "index", label: "Pages in search cross-checked with expectations" },
        { id: "queries", label: "Commercial-core query groups set up" },
        { id: "tools", label: "robots/server response checked after a release" },
        { id: "gsc", label: "Google Search Console watched in parallel" },
        { id: "support", label: "Tickets only after self-check" },
        { id: "time", label: "Reports not confused with a one-month TOP guarantee" },
      ],
    },
    quizzes: [
      {
        afterTitleIncludes: "Indexing: crawls, sitemap, moves",
        title: "Mini quiz: Webmaster",
        lead: "Two checks.",
        questions: [
          {
          ...
          },
          {
            ...
            correct: 1,
            explain: "Two search tracks — two panels.",
          },
        ],
      },
    ],
  ...
  "trendy-seo": {
    checklist: {
      ...
      items: [
        ...
        { id: "snippet", label: "Title/description strengthened on key URLs" },
        { id: "mobile", label: "First screen and mobile UX checked" },
        { id: "zombies", label: "Thin URLs glued or pulled from the index" },
        { id: "mentions", label: "White-hat mentions/outreach plan exists" },
        { id: "panels", label: "Webmaster and GSC in the weekly ritual" },
    ...
    quizzes: [
      {
        ...
        questions: [
          ...
          {
            id: "tr2",
            question: "The best answer to meaning-aware algorithms…",
            options: [
              "Stuff keys denser",
              "A full answer to the user’s job and strong landings",
              "Ignore snippets",
            ...
            correct: 1,
            explain: "Intent and value beat density.",
          },
        ],
      },
    ],
  ...
  "tochki-vhoda": {
    checklist: {
      ...
      lead: "After reviewing competitors.",
      items: [
        { id: "core", label: "Your own core (at least a draft) is gathered" },
        { id: "serp", label: "TOP for the core pulled, candidate domains listed" },
        { id: "ep", label: "3–10 EPs per top competitor logged" },
        { id: "keys", label: "Keys from strong URLs exported and clustered" },
        { id: "gaps", label: "Gaps in your landings turned into tasks" },
        { id: "nocopy", label: "Plan without copy-pasting others’ copy" },
        { id: "own", label: "Your organic landing pages checked in analytics" },
        { id: "time", label: "Research ≠ instant TOP" },
      ],
    },
    quizzes: [
        ...
        questions: [
          {
            ...
            options: [
              "Only the homepage",
              "The first-touch page in a session (from search — often a landing)",
              "The robots.txt file",
              "A link marketplace",
            ],
            correct: 1,
            explain: "EP = first URL of the visit; from organic often not the homepage.",
          },
          {
            id: "ep2",
            question: "Exporting keys from a competitor EP is needed to…",
            options: [
              "Copy the text one-to-one",
              "Expand the core and understand strong landing intent",
              "Guarantee TOP in a month",
              "Replace Webmaster",
            ],
            correct: 1,
            explain: "Hypotheses and semantics — not copy-paste.",
  ...
  "cpm-ili-cpc": {
    checklist: {
      afterTitleIncludes: "How to choose",
      title: "Before choosing CPM/CPC",
      lead: "Goal first, then the payment model.",
      items: [
        { id: "goal", label: "Goal: reach or leads/sales" },
        { id: "kpi", label: "KPI and acceptable CPA defined" },
        { id: "lp", label: "For CPC a landing matches the offer" },
        { id: "creative", label: "For CPM a strong creative exists" },
        { id: "target", label: "Audience/targeting set" },
        { id: "utm", label: "Click tracking (UTM/cabinet) set" },
        { id: "test", label: "Test budget and window locked" },
        { id: "compare", label: "Compare leads/revenue, not CTR alone" },
      ],
    },
    quizzes: [
      {
        ...
        questions: [
          {
            id: "cc1",
            question: "CPM is primarily about…",
            options: [
              "Paying only for a purchase",
              "Paying for impressions (usually per 1,000)",
              "A lead guarantee",
            ...
            correct: 1,
            explain: "You pay for shows, not the click.",
          },
          {
            id: "cc2",
            question: "If the goal is site leads, closer usually is…",
            options: [
              "Max CPM only with no landing",
              "CPC/CPA and conversion control",
              "Dropping analytics",
